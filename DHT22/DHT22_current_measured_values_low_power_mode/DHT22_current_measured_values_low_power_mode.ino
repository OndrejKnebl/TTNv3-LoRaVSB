...
* 
* Modified for DHT22 - current measured values and Low Power Mode, 30. 3. 2022
*******************************************************************************/
...
void do_send(osjob_t* j){
    ...
    if(dht.getState() == DHT_OK){
        ...
        os_setCallback(&sendjob, do_send);    // If the values are not measured, call do_send again
    }
}
